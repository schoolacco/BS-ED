...
#----------- AREAS --------------
  ...
  Realm(root, { #TLA
      "Stargazed Metal": [
          ...
          ("500 Plasma: 2 Stargazed Metal", lambda: reset_button_special(500, "Plasma", 2, "Stargazed Metal", list(abs_stat_info["Moonbase"].keys()).remove("Solargems"))),
          ("10k Badges: 3 Stargazed Metal", lambda: reset_button_special(10000, "Badges", 3, "Stargazed Metal", list(abs_stat_info["Nostalgia World"].keys()).remove("Rogems"))),
      ],
      "Gyge": [
